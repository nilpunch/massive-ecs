...
namespace Massive
{
	...
	public struct PackedMaskedEnumerator : IDisposable
	{
		...
		public PackedMaskedEnumerator(PackedSet packedSet, Mask rentedMask, Packing packingWhenIterating = Packing.WithHoles)
		{
