...
//
// 		public static BitSet[] FixtureSets =
// 		{
// 			new BitSet(),
// 			new BitSet(packing: Packing.WithHoles),
...
// 		};
//
// 		public static BitSet[] FixtureMassiveSets =
// 		{
// 			new MassiveBitSet(2),
// 			new MassiveBitSet(2, packing: Packing.WithHoles),
...
// 		public void SparseSet_Ensure(BitSet set)
// 		{
// 			set.Clear();
// 			set.ResizeSparse(0);
// 			set.ResizePacked(0);
...
//
// 		[TestCaseSource(nameof(FixtureSets)), Performance]
// 		public void SparseSet_Remove(BitSet set)
// 		{
// 			set.Clear();
// 			set.ResizeSparse(0);
// 			set.ResizePacked(0);
...
// 		
// 		[TestCaseSource(nameof(FixtureSets)), Performance]
// 		public void SparseSet_IsAssigned(BitSet set)
// 		{
// 			set.Clear();
// 			set.ResizeSparse(0);
// 			set.ResizePacked(0);
...
//
// 		[TestCaseSource(nameof(FixtureSets)), Performance]
// 		public void SparseSet_RemoveNonExisting(BitSet set)
// 		{
// 			set.Clear();
// 			set.ResizeSparse(0);
// 			set.ResizePacked(0);
...
// 		public void MassiveSparseSet_Save(BitSet set)
// 		{
// 			set.Clear();
// 			set.ResizeSparse(0);
// 			set.ResizePacked(0);
...
// 		
// 		[TestCaseSource(nameof(FixtureMassiveSets)), Performance]
// 		public void MassiveSparseSet_BigSave(BitSet set)
// 		{
// 			set.Clear();
// 			set.ResizeSparse(0);
// 			set.ResizePacked(0);
